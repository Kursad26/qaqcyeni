/*
  # İmalat Birimi Ekleme - NOI Modülü

  ## Değişiklikler
  1. noi_requests tablosuna manufacturing_unit_id kolonu ekleme
  2. create_noi_request fonksiyonunu güncelleme (manufacturing_unit_id parametresi ekleniyor)
*/
...
-- 2. Eski fonksiyonu sil ve yeni fonksiyonu oluştur
DROP FUNCTION IF EXISTS create_noi_request(uuid, date, time, uuid, uuid, uuid, text, uuid);
