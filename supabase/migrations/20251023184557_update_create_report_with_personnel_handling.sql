/*
  # Update Field Observation Report Creation with Personnel Handling

  ## Changes
  - Automatically create personnel records for admins if they don't exist
  - Handle virtual personnel IDs from frontend
  - Ensure personnel IDs are valid before creating report
*/
...
BEGIN
  ...
  -- Create the report with actual personnel IDs
