/*
  # Fix Field Training Report Creation Function

  ## Problem
  - Function may fail with null handling
  - Settings kontrolü eksik olabilir

  ## Solution
  - Proper null handling
  - Better error messages
  - Check if settings exist before creating
*/

-- Drop and recreate the function with proper null handling
DROP FUNCTION IF EXISTS create_field_training_report;
...
BEGIN
  ...
  IF NOT v_has_permission THEN
    RAISE EXCEPTION 'Eğitim oluşturma yetkiniz yok. Lütfen proje yöneticisiyle iletişime geçin.';
  END IF;
