...
export function NoiPage() {
  ...
  const [showAllNois, setShowAllNois] = useState(false);
              ...
              {toggleStates.myPending && (
                <div className="p-4">
                  ...
                  <ResizableTable
                    ...
                    data={showAllPending ? sortedPendingNois : sortedPendingNois.slice(0, 10)}
                  ...
                  {sortedPendingNois.length > 10 && (
                    <div className="flex justify-center py-4 border-t border-gray-200">
                      <button
                        onClick={() => setShowAllPending(!showAllPending)}
                        className="px-4 py-2 text-sm text-blue-600 hover:text-blue-700 font-medium"
                      >
                        {showAllPending ? `Daha Az Göster (10 satır)` : `Tümünü Göster (${sortedPendingNois.length} satır)`}
                      </button>
                    </div>
                  )}
                </div>
